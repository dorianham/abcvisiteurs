...
let startWindow
var openedurl = "";
var abcvisiteurs_protocol = 'abcvisiteurs';
...
app.setAsDefaultProtocolClient(abcvisiteurs_protocol)
...
function send_opened_url(openedurl)
{
    if(openedurl != "")
    {
        startWindow.webContents.send('opened-url', openedurl.toString().replace(abcvisiteurs_protocol+"://", "").replace("/", ""));
    }
}
